...
/**
 * @notice Mock ERC20 token including a fee switch to test fee-on-transfer use cases.
 */
contract MockERC20 is ERC20 {
    ...
    // Override the OZ's internal `_update` function to implement a fee
    function _update(address _from, address _to, uint256 _amount) internal virtual override {
        ...
        if (_feePct != 0) {
            ...
            // Call the parent implementation of `_update`, subtracting the fee
